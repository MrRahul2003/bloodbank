            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    ...
                    <section class="widget widget-light-skin">
                        ...
                        <p class="text-white">Emergency Phone: 8108595232</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <section class="widget widget-links widget-light-skin">
                        ...
                        <ul>
                            <li><a href="#" style="text-decoration:none">Become a Monthly Giver</a></li>
                            <li><a href="#" style="text-decoration:none">Make a Single Donation</a></li>
                            <li><a href="#" style="text-decoration:none">Other ways to Give</a></li>
                            <li><a href="#" style="text-decoration:none">Publications</a></li>
                        </ul>
                    </section>
                </div>
            </div>
